...
public class WeixinController {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
			throws ServletException, IOException, org.apache.http.ParseException, ParseException {
			...
			if (Event.equals("subscribe")) {
				...
				if (s == null) {
					...
					if (todayStartTimeStamp.after(ts)) {
						...
						final long missDays = (System.currentTimeMillis() - dtime) / (24 * 60 * 60 * 1000); // 连续签到则等于
																											// 0
						...
						if (missDays == 1) {
							...
							case 1:
								...
								break;
							case 2:
								s.setIntegration(s.getIntegration() + 2);
								break;
							case 3:
								s.setIntegration(s.getIntegration() + 4);
								break;
							case 4:
								s.setIntegration(s.getIntegration() + 8);
								break;
							case 5:
								s.setIntegration(s.getIntegration() + 16);
								break;
							case 6:
								s.setIntegration(s.getIntegration() + 32);
								break;
							case 7:
								s.setIntegration(s.getIntegration() + 64);
								break;
							default:
								s.setIntegration(s.getIntegration() + 64);
								break;
